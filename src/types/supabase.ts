...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_session: {
        Args: { p_include_scenarios?: boolean; p_session_id: string }
        Returns: Json
      }
      get_session_core: { Args: { p_session_id: string }; Returns: Json }
      get_session_scenarios: { Args: { p_session_id: string }; Returns: Json }
      get_sessions: {
        Args: never
        Returns: {
          created_at: string
